...
ACTIVITY_FILE = os.path.join(BASE_DIR, "sorghumdata", "Sorghum_ActivityAnnotated.csv")
COUNT_FILE    = os.path.join(BASE_DIR, "sorghumdata", "sorghum_gene_count_4pcs_0.01.csv")
OUT_CSV       = os.path.join(BASE_DIR, "results", "activator_count_genes_test_sorghum.csv")
OUT_PNG       = os.path.join(BASE_DIR, "results", "activator_count_genes_boxplot_sorghum.png")
